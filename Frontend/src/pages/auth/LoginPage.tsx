    ...
    <div className={styles.container}>
      <div className={styles.card}>
        ...
        {searchParams.get('registered') && (
          <p className={styles.success}>Account created! Please check your email to verify.</p>
        )}
        ...
        <form onSubmit={handleSubmit} className={styles.form} noValidate>
          {!mfaRequired ? (
            ...
            <div className={styles.field}>
              <label htmlFor="mfaCode">Enter the 6-digit code from your authenticator app</label>
              <input
                id="mfaCode"
                type="text"
                inputMode="numeric"
          ...
          >
            {login.isPending ? 'Signing in...' : mfaRequired ? 'Verify' : 'Sign in'}
          </button>
        </form>
        ...
        {!mfaRequired && (
          <>
            <div style={{ textAlign: 'center', margin: '1rem 0' }}>
              <Link to="/forgot-password" style={{ fontSize: '0.875rem', color: '#1a56db' }}>
