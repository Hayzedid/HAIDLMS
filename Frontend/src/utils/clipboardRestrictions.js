...
export class ClipboardRestrictionManager {
    ...
    userId;
    onAttemptLogged;
    internalClipboard = ''; // Internal clipboard for within-IDE copy/paste
    constructor(config, sessionId, userId, onAttemptLogged) {
        this.config = config;
     ...
     */
    initializeRestrictions(editorElement) {
        const listeners = [];
        // ====================================================================
 ...
 */
export function useClipboardRestrictions(config, sessionId, userId, onAttemptLogged) {
    const manager = new ClipboardRestrictionManager(config, sessionId, userId, onAttemptLogged);
    return {
        manager,
        initializeRestrictions: (element) => manager.initializeRestrictions(element),
    };
}
/**
 ...
 */
export const PERMISSIVE_CONFIG = {
    pasteEnabled: true,
    copyEnabled: true,
    cutEnabled: true,
