...
export default function WebcamCapture({ sessionId, userId, onCapture, captureInterval = 10, width = 640, height = 480, showPreview = true, onError, autoUpload = true, }) {
    ...
    return (_jsxs("div", { style: { position: 'relative' }, children: [showPreview && (_jsxs("div", { style: {
                    position: 'relative',
                    width: `${width}px`,
                    height: `${height}px`,
                    backgroundColor: '#000',
                    borderRadius: '8px',
                    overflow: 'hidden',
                }, children: [_jsx("video", { ref: videoRef, autoPlay: true, playsInline: true, muted: true, style: {
                            width: '100%',
                            height: '100%',
                            objectFit: 'cover',
                            ...
                            padding: '1rem',
                            textAlign: 'center',
                        }, children: _jsxs("div", { children: [_jsx("div", { style: { fontSize: '48px', marginBottom: '1rem' }, children: "\uD83D\uDCF7" }), _jsx("div", { style: { fontWeight: 'bold', marginBottom: '0.5rem' }, children: "Webcam Access Required" }), _jsx("div", { style: { fontSize: '14px', color: '#ccc' }, children: error })] }) })), isActive && !error && (_jsxs("div", { style: {
                            position: 'absolute',
                            top: '10px',
                            right: '10px',
                            ...
                            gap: '4px',
                                ...
                                } }), "RECORDING"] }))] })), _jsx("canvas", { ref: canvasRef, style: { display: 'none' }, width: width, height: height }), _jsx("style", { children: `
        @keyframes pulse {
          0%, 100% { opacity: 1; }
          50% { opacity: 0.5; }
        }
